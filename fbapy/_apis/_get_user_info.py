...
import json
def get_user_info(default_funcs: DefaultFuncs, ctx: dict):
        ...
        def get_info(uid:str):
            ...
            data=default_funcs.post_with_defaults("https://www.facebook.com/chat/user_info/",form,ctx).text
            return format_data(
                 json.loads(
                      data.replace("for (;;);",""))["payload"]["profiles"]
                      )
        return get_info