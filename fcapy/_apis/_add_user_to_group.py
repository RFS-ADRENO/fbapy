...
def add_user_to_group(default_funcs: DefaultFuncs, ctx: dict):
		def add(list_uid:list,thread_id:str):
			...
			for id in range(len(list_uid)):
				form["log_message_data[added_participants][" + str(id) + "]"] = "fbid:" + list_uid[id]
			default_funcs.post_with_defaults("https://www.facebook.com/messaging/send/",form,ctx)
		return add